...
// echo $id_user;
?>
<?php include_once 'core/ajax/modal.php';?>
<body>
<!--Home Content-->
<section id="cover">
  <div id="cover-caption">
 <!-- nav -->
<nav class="navbar navbar-expand-lg s fixed-top">
...
<ul class="nav justify-content-center" >
 ...
 <div class="dropdown show">
  <a class="nav-link dropdown-toggle" href="" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    Welcome, <?php $connect->get_user($id_user);?>
  </a>
  <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
    <a class="dropdown-item" data-toggle="modal" data-target="#myModal" href="">View Ordered</a>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
            <center><h4 class="modal-title">Thank you for Ordering!</h4></center>
